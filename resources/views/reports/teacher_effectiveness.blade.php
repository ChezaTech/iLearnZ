...
<body>
    ...
    <div>
        <h2>Overview</h2>
        <p>This report evaluates teacher effectiveness based on student engagement, assignment completion rates, and
            overall student performance.</p>
    </div>
    ...
    <div class="summary">
        ...
        <ul>
            <li>Average student engagement across all teachers:
                {{ number_format(collect($data)->avg('student_engagement'), 1) }}%</li>
            <li>Average assignment completion rate:
                {{ number_format(collect($data)->avg('assignment_completion'), 1) }}%</li>
