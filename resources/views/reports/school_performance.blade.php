...
<body>
    ...
    <div>
        <h2>Overview</h2>
        <p>This report provides a comprehensive analysis of school performance metrics across all schools in the system
    ...
    <div class="summary">
        ...
        <ul>
            <li>Average attendance rate across all schools:
                {{ number_format(collect($data)->avg('attendance_rate'), 1) }}%</li>
            <li>Average assignment completion rate: {{ number_format(collect($data)->avg('completion_rate'), 1) }}%
            </li>
