...
<body>
    ...
    <div>
        <h2>Overview</h2>
        <p>This report tracks student academic progress and attendance across the system during the specified period.
        </p>
    </div>
    ...
    <div class="summary">
        ...
        <ul>
            <li>Average attendance rate across all students:
                {{ number_format(collect($data)->avg('attendance_rate'), 1) }}%</li>
