...
<body>
    ...
    <div>
        <h2>Overview</h2>
        <p>This report analyzes educational resource usage and distribution across all schools in the system during the
            specified period.</p>
    </div>
    ...
    <div class="summary">
        ...
        <ul>
            <li>Average digital resource usage across all schools:
                {{ number_format(collect($data)->avg('digital_resource_usage'), 1) }}%</li>
            <li>Average physical resource usage: {{ number_format(collect($data)->avg('physical_resource_usage'), 1) }}%
            </li>
