    ...
    const teamMembers = [
        {
            ...
            bio: "With over 15 years in educational technology, Dr. Mwanza founded iLearn to transform education across Africa.",
        },
        {
            name: "Michael Banda",
    ...
    const milestones = [
        {
            ...
            title: "Foundation",
            description:
                "iLearn was founded with a vision to transform education across Africa through technology.",
        },
        {
            year: "2019",
            title: "First School Partnership",
            description:
                "Launched our pilot program with 5 schools in Lusaka, reaching over 1,000 students.",
        },
        {
            year: "2020",
            title: "Digital Response",
            description:
                "Expanded rapidly to support remote learning during global pandemic, serving 50+ schools.",
        },
        {
            year: "2021",
            title: "Government Recognition",
            description:
                "Received official endorsement from Ministry of Education for our innovative approach.",
        },
        {
            year: "2022",
            title: "Pan-African Expansion",
            description:
                "Extended operations to 5 countries across Southern Africa, serving 100,000+ students.",
        },
        {
            year: "2023",
            title: "AI Integration",
            description:
                "Introduced adaptive learning features powered by AI to personalize education.",
        },
        {
            year: "2024",
            title: "Global Recognition",
            description:
                "Awarded 'Most Innovative EdTech Solution' at the Global Education Summit.",
        },
    ];
                            ...
                            <div className="container mx-auto px-10 lg:px-16">
                                <div className="text-center max-w-4xl mx-auto">
                                    ...
                                    <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
                                        Revolutionizing education across Africa
                                        through innovative technology and a
                                        passion for creating equal learning
                    ...
                    <div className="container mx-auto px-6 py-12">
                        ...
                        {activeTab === "mission" && (
                            <div className="grid md:grid-cols-2 gap-12 items-center">
                                <div>
                                    <h2 className="text-3xl font-bold text-[#1e5091] mb-6">
                                        Our Mission
                                    </h2>
                                    <div className="h-1 w-20 bg-[#ffb81c] mb-6 rounded-full"></div>
                                    <p className="text-gray-700 mb-6 text-lg">
                                        At iLearn, our mission is to democratize
                                        quality education across Africa through
                                    ...
                                    <p className="text-gray-700 mb-6 text-lg">
                                        ...
                                        socioeconomic background. Our platform
                                        bridges these gaps by providing digital
                                        tools that enhance teaching and learning
                                        experiences.
                                    </p>
                                    <h2 className="text-3xl font-bold text-[#1e5091] mb-6 mt-12">
                                        Our Vision
                                    </h2>
                                    <div className="h-1 w-20 bg-[#ffb81c] mb-6 rounded-full"></div>
                                    <p className="text-gray-700 mb-6 text-lg">
                                        To create a future where every African
                                        student has equal access to world-class
                                        education, empowering the next
                                        generation of leaders, innovators, and
                                        changemakers.
                                    </p>
                                </div>
                            ...
                            <div>
                                <div className="text-center mb-12">
                                    ...
                                    <p className="text-gray-700 max-w-3xl mx-auto text-lg">
                                        Our diverse team of education experts,
                                        technologists, and visionaries work
                                        together to revolutionize learning
                                        across Africa.
                                    </p>
                                </div>
                                ...
                                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                                    {teamMembers.map((member, index) => (
                                        ...
                                        >
                                            ...
                                            />
                                            <div className="p-6">
                                                <h3 className="text-xl font-bold text-[#1e5091]">
                                                    {member.name}
                                                </h3>
                                                <p className="text-[#ffb81c] font-medium mb-3">
                                                    {member.role}
                                                </p>
                                ...
                                <div className="mt-16 bg-[#1e5091]/5 rounded-xl p-8 border border-[#1e5091]/10">
                                    <h3 className="text-2xl font-bold text-[#1e5091] mb-4">
                                        Join Our Team
                                    </h3>
                                    <p className="text-gray-700 mb-6">
                                        We're always looking for passionate
                                        individuals to join our mission of
                                        transforming education across Africa.
                                        Check out our current openings or send
                                        us your resume.
                                    </p>
                                    <a
                                        href="#"
                        ...
                        {activeTab === "history" && (
                            <div>
                                <div className="text-center mb-12">
                                    ...
                                    <div className="h-1 w-20 bg-[#ffb81c] mx-auto mb-6 rounded-full"></div>
                                    <p className="text-gray-700 max-w-3xl mx-auto text-lg">
                                        From a small startup to a leading EdTech
                                        platform across Africa, our journey has
                                        ...
                                        >
                                            ...
                                            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-100">
                                                <div className="flex items-center mb-3">
                                                    <span className="text-[#ffb81c] font-bold text-xl mr-3">
                                                        {milestone.year}
                                                    </span>
                                                    <h3 className="text-xl font-bold text-[#1e5091]">
                                                        {milestone.title}
                            ...
                            <div>
                                <div className="text-center mb-12">
                                    ...
                                    <p className="text-gray-700 max-w-3xl mx-auto text-lg">
                                        ...
                                        organizations to expand our impact and
                                        improve educational outcomes across
                                        Africa.
                                    </p>
                                </div>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-16">
                                    {partners.map((partner, index) => (
                                        <div
                                            key={index}
                                            className="bg-white rounded-lg shadow-md p-4 flex items-center justify-center transition-transform hover:scale-105"
                                        >
                                            <img
                                                src={partner.logo}
                                                alt={partner.name}
                                ...
                                <div className="bg-[#1e5091]/5 rounded-xl p-8 border border-[#1e5091]/10">
                                    ...
                                    <p className="text-gray-700 mb-6">
                                        Join our network of partners and help us
                                        transform education across Africa.
                                        Whether you're a government agency, NGO,
                                        or private organization, we welcome
                    ...
                    <div className="bg-[#1e5091] text-white py-16">
                        <div className="container mx-auto px-6 text-center">
                            <h2 className="text-3xl font-bold mb-6">
                                Ready to transform your school with iLearn?
                            </h2>
                            <p className="text-xl text-white/80 max-w-2xl mx-auto mb-8">
                                Join thousands of schools across Africa that are
                                already using our platform to enhance teaching
