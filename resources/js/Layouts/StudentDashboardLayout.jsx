    ...
    return (
        <Box sx={{ display: "flex" }}>
            ...
            <DrawerStyled variant="permanent" open={open}>
                <DrawerHeader>
                    <LogoContainer
                        sx={{ flexGrow: 1, display: open ? "flex" : "none" }}
                    >
                        <Box
                            sx={{
                                display: "flex",
                        ...
                        <Typography className="logo-text">EDUCATION</Typography>
                    </LogoContainer>
            ...
            >
                ...
                <MenuItem>
                    <Box sx={{ width: "100%" }}>
                        ...
                        <Typography variant="body2" color="text.secondary">
                            New study material for English has been uploaded
                        </Typography>
                    </Box>
                </MenuItem>
                <Divider />
